 ...
 *
 */
public class HandCodedPlayer_mfortman extends NannonPlayer {

	/** 
	 * You should rename this file to:  HandCodedPlayer_yourLoginName.java
	 * 
	 */
	public HandCodedPlayer_mfortman() {
	}

	public HandCodedPlayer_mfortman(NannonGameBoard gameBoard) {
		super(gameBoard);
	}
	@Override
	public String getPlayerName() {
		...
		return "mfortman's Hand-Coded Player";
	}
