...
/**
 * Copyrighted 2013, 2014, and 2015 by Jude Shavlik.  Maybe be freely used for non-profit educational purposes.
 */
...
// 	 "\n" +
	...
	public static void main(String[] argsRaw) {
		...
		Utils.randomInstance = new Random(123);  // This is the SEED for the pseudo-random number generator.  
		...
		String   arg1 = "greedyHandCoded"; // See argsSpecString for other options.
		String   arg2 = "FullJointProbTablePlayer_mfortman";
		...
		Nannon.setReportLearnedModels(true);
